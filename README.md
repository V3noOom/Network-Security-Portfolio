...
An authorized assessment that uncovered a horizontal privilege escalation vulnerability in an internal Git hosting service — any authenticated user could push to any repository. Covers root cause analysis, OWASP/CWE classification, impact assessment, and remediation guidance.
**Tools:** Git, manual enumeration

## About

I'm an MSc Information Security student at Stockholm University (Stockholm, Sweden), focused on hands-on security testing and applied defense. These projects were completed as part of coursework in Network Security (IB433C).
